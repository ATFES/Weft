...
| mul_mat:q2_k-decode | 1×4096×4096 | 6.987 | 6.066 | 1.152 | — |
| mul_mat:q2_k-prefill | 128×4096×4096 | 842.445 | 768.586 | 1.096 | — |
| mul_mat:q3_k-decode | 1×4096×4096 | 5.182 | 8.117 | 0.638 | — |
| mul_mat:q3_k-prefill | 128×4096×4096 | 608.990 | 842.215 | 0.723 | — |
| mul_mat:q4_k-decode | 1×4096×4096 | 4.275 | 6.507 | 0.657 | — |
| mul_mat:q4_k-prefill | 128×4096×4096 | 305.430 | 833.831 | 0.366 | — |
| mul_mat:q5_k-decode | 1×4096×4096 | 8.056 | 11.748 | 0.686 | — |
| mul_mat:q5_k-prefill | 128×4096×4096 | 621.035 | 1483.553 | 0.419 | — |
| mul_mat:q6_k-decode | 1×4096×4096 | 7.615 | 6.573 | 1.159 | — |
| mul_mat:q6_k-prefill | 128×4096×4096 | 817.626 | 792.940 | 1.031 | — |
...
交叉比值中位 1.032（范围 0.437~1.120）：JIT warm 计时与正式协议 Weft 测量基本吻合，差异在
